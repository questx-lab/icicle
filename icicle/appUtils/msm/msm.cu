...
#define MAX_TH 256
      ...
      cudaStream_t stream)
    {
      ...
      cub::DeviceRadixSort::SortPairsDescending(
        ...
        single_bucket_indices, sorted_single_bucket_indices, h_nof_buckets_to_compute, 0, sizeof(unsigned) * 8, stream);
      ...
      cudaStream_t stream)
    {
      ...
      split_scalars_kernel<<<NUM_BLOCKS, NUM_THREADS, 0, stream>>>(
        bucket_indices + msm_size, point_indices + msm_size, d_scalars, total_size, msm_log_size, nof_bms, bm_bitsize,
        c);
